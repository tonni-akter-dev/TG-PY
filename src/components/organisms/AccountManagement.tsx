...
export function AccountManagement() {
  ...
  const handleConnect = async () => {
    ...
    try {
      const response = await fetch(`https://api.vipadtg.com/api/v1/accounts/connect/start`, {
        method: 'POST',
        headers: {
  ...
  const handleVerify = async () => {
    ...
    try {
      const response = await fetch(`https://api.vipadtg.com/api/v1/accounts/connect/verify`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`
  ...
  const handleRemoveAccount = async (phone: string) => {
    ...
    try {
      const response = await fetch(`https://api.vipadtg.com/api/v1/accounts/${phone}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`
        }
  ...
  const handleDeactivateAll = async () => {
    ...
    try {
      const response = await fetch(`https://api.vipadtg.com/api/v1/accounts/deactivate-all`, {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${token}`
        }
  ...
  const handleActivateAll = async () => {
    ...
    try {
      const response = await fetch(`https://api.vipadtg.com/api/v1/accounts/activate-all`, {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${token}`
        }

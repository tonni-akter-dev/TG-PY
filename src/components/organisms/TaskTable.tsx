  ...
  // State for met
    ...
    const handleStart = async (taskId: string) => {
        try {
            ...
            // Call the start API
            const response = await fetch(`http://185.255.131.231:8000/api/v1/forwarder/task/${taskId}/start`, {
                method: 'POST',
                headers: {
    ...
    const handleStop = async (taskId: string) => {
        try {
            ...
            // Call the stop API
            const response = await fetch(`http://185.255.131.231:8000/api/v1/forwarder/task/${taskId}/stop`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    const fetchTasks = async (page: number = 1, size: number = 5) => {
        try {
            ...
            const response = await fetch(`http://185.255.131.231:8000/api/v1/forwarder/task?page=${page}&size=${size}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
